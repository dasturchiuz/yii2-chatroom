...
//            ],
    ...
    //return $user_id;
        ...
        [
            ...
            'format'=>'html',
            'value'=>function($data) use($user_id){
                return \yii\helpers\Html::a(substr($data->text, 0, 100), ['/my-shop/read-messages', 'chat_room'=>$data->chatroom_id, 'id'=>$data->sender_id == $user_id ? $data->receiver_id : $data->sender_id], ['class'=>'text-info']);
            }
        ],
        [
            'label'=>'Время',
